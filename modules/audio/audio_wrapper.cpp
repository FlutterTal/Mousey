...
static SQInteger squirrel_sound_destructor(SQUserPointer p, SQInteger SQ_UNUSED_ARG(size)) {
...
static SQInteger squirrel_sound_pause(HSQUIRRELVM v) {
    Sound * instance;
    sq_getinstanceup(v, 1, (SQUserPointer *)&instance, (SQUserPointer)"SoundTag", SQTrue);
    instance->pause();
    return 0;
...
static SQInteger squirrel_sound_stop(HSQUIRRELVM v) {
    Sound * instance;
    sq_getinstanceup(v, 1, (SQUserPointer *)&instance, (SQUserPointer)"SoundTag", SQTrue);
    instance->stop();
    return 0;
...
void register_audio_wrapper(HSQUIRRELVM v) {
    ...
    sq_newclosure(v, squirrel_sound_pause, 0);
    sq_setparamscheck(v, 1, _SC("x"));
    sq_newslot(v, -3, SQFalse);

    sq_pushstring(v, _SC("stop"), -1);
    sq_newclosure(v, squirrel_sound_stop, 0);
    sq_setparamscheck(v, 1, _SC("x"));
    sq_newslot(v, -3, SQFalse);
